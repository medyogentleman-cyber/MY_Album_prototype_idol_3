...
file_path = "C:/Users/naoki/OneDrive/デスクトップ/Antigravity/MY_Album_prototype_idol_2_jp_en/index.html"
with open(file_path, 'r', encoding='utf-8') as f:
    html = f.read()

# Make sure lang.js is included, and add language switcher button
...
replacements = {
    ...
    'Googleでログイン': '<span data-i18n="login_google">Googleでログイン</span>',
    'Meta (Facebook) でログイン': '<span data-i18n="login_facebook">Meta (Facebook) でログイン</span>',
    'Meta (Instagram) でログイン': '<span data-i18n="login_instagram">Meta (Instagram) でログイン</span>',
    ...
    '<p style="font-size:12px; font-weight:800; color:#2d3748; margin-bottom:12px;">💡 データ転送量についての大切なお知らせ</p>': '<p style="font-size:12px; font-weight:800; color:#2d3748; margin-bottom:12px;" data-i18n="plan_notice_title">💡 データ転送量についての大切なお知らせ</p>',
    ...
    '<p style="text-align:center; font-size:11px; color:#a0aec0; margin-top:24px; font-weight:700;">※ これは外部決済ページ（モック）のデモ画面です</p>': '<p style="text-align:center; font-size:11px; color:#a0aec0; margin-top:24px; font-weight:700;" data-i18n="demo_note1">※ これは外部決済ページ（モック）のデモ画面です</p>',
    ...
    # Javascript strings replacements
